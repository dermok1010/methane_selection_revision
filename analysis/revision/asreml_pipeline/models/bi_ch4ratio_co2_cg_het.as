...
bivariate_bi_ch4ratio_co2_cg_het -- generated by 01_generate_models.R
 ANI_ID !P
 ch4_g_day2_1v3 1
 co2_g_day2_1v3 1
 ch4_ratio 1
...
ch4_ratio co2_g_day2_1v3 ~ Trait Tr.SEX Tr.TX Tr.BR Tr.SU Tr.CL Tr.CV Tr.LY Tr.UN Tr.het Tr.rec Tr.REARING_RANK Tr.BIRTH_RANK Tr.ewe_birth_rank Tr.ewe_rearing_rank Tr.age_in_weeks Tr.dam_parity_group_num Tr.ch4_GroupNumber mv !r us(Trait).ped(ANI_ID) diag(Trait !INIT 0.000001 17141).ide(ANI_ID)
residual sat(cg_mean_cl).us(Trait).units

# NOTE: Reviewer-1 CG-heterogeneity follow-up (2026-09-20, generalized from the bi_methane_ch4mbw_cg_het_trial prototype): ch4ratio x co2 with class-specific residual US matrices; discovery-only; DO NOT submit before the single trial prototype has confirmed this structure is stable -- see config/models.yaml's key_bivariates_cg_het comment.
